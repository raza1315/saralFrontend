  ...
  return (
    <div className='w-full h-screen flex flex-col justify-center items-center gap-5 '>
      ...
      <div className='w-1/3 h-[5rem] flex bg-white justify-around items-center px-2 gap-2'>
        <p className='text-3xl bg-gray-200 hover:text-white text-black cursor-pointer hover:bg-red-500 flex-1 text-center py-[1rem] transition-all duration-300 ease-in-out'>Join Room</p>
        <p className='text-3xl bg-gray-200 text-black cursor-pointer hover:bg-green-400 hover:text-white flex-1 text-center py-[1rem] transition-all duration-300 ease-in-out'>Create Room</p>
      </div>
